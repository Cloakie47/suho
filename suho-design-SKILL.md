...
4. LIVE ON GIWA — the credibility strip: "First EIP-7702 passkey account on GIWA" (gild), preconf timing "~0.9s", "4 contracts source-verified", "500,000+ verified names indexed" (rendered live from the guardian). Mono type, each linking to explorer/GitHub evidence.
